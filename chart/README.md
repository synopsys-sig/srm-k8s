...
![Version: 1.5.0](https://img.shields.io/badge/Version-1.5.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2023.8.5](https://img.shields.io/badge/AppVersion-2023.8.5-informational?style=flat-square)
...
| web.image.tag | string | `"v2023.8.5"` | the Docker image version for the SRM web workload |
