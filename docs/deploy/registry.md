...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.9.4.1
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.9.4.1 id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2024.9.4.1
...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.9.4.1
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.9.4.1 id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2024.9.4.1
...
- repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.9.4.1
...
- repo.blackduck.com/containers/codedx/codedx-mariadb:v1.35.0
...
- repo.blackduck.com/containers/codedx/codedx-tools:v2024.9.4.1
- repo.blackduck.com/containers/codedx/codedx-toolsmono:v2024.9.4.1
- repo.blackduck.com/containers/codedx/codedx-prepare:v2.4.0
- repo.blackduck.com/containers/codedx/codedx-newanalysis:v2.4.0
- repo.blackduck.com/containers/codedx/codedx-results:v2.4.0
- repo.blackduck.com/containers/codedx/codedx-tool-service:v2.4.0
- repo.blackduck.com/containers/codedx/codedx-cleanup:v2.4.0
