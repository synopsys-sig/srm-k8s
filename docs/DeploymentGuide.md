...
| to.image.tag | string | `"v1.33.0"` | the Docker image version for the SRM Tool Orchestration workloads (tools and toolsMono use the web.image.tag version)|
...
| web.image.tag | string | `"v2024.3.3"` | the Docker image version for the SRM web workload |
